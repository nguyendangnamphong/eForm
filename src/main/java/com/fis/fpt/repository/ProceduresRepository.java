...
import com.fis.fpt.service.dto.ProcedureDto;
...
public interface ProceduresRepository extends JpaRepository<Procedures, String> {
    ...
    @Query(value = "Select new com.fis.fpt.service.dto.ProcedureDto(procedure.createdDate, procedure.procedureName, procedure.stepName, procedure.versionId, procedure.procedureId, procedure.stepId) " +
        "From Procedures  procedure " +
        "where procedure.formId = :formId " +
