...
import com.fis.fpt.search.FormSearchOwnerExcel;
...
public interface FormRepository extends JpaRepository<Form, String>, JpaSpecificationExecutor<Form> {
    ...
    @Query(value = " Select new com.fis.fpt.service.dto.FormDto(form.formId, form.formName, form.statusForm, form.createdDate, form.tag, form.beginTime, form.endTime, form.lastModifiedDate, form.jsonForm, form.description, form.formCode, form.jsonFormCondition, form.createdBy, form.userId, form.orgIn, form.custId, form.codeJson, form.configWriter) "
            +
            " From Form  form " +
    ...
    @Query(value = " Select new com.fis.fpt.service.dto.FormDto(form.formId, form.formName, form.statusForm, form.createdDate, form.tag, form.beginTime, form.endTime, form.lastModifiedDate, form.description, form.formCode, form.createdBy, form.userId, form.orgIn, form.custId, form.configWriter) "
            +
            " From Form  form " +
            " WHERE form.createdBy = :#{#formSearchOwner.createdBy} " +
            " And form.orgIn = :orgIn" +
    ...
    @Query(value = "Select new com.fis.fpt.service.dto.FormShareDto(form.formId, form.formName, form.createdBy,  form.statusForm, form.createdDate, form.tag, form.beginTime, form.endTime, form.jsonForm, form.description, form.formCode, form.variableArr, form.jsonFormCondition, form.codeJson, form.configWriter) "
            +
            " From Acl author " +
            " Join Form  form " +
    ...
    @Query(value = "Select new com.fis.fpt.service.dto.FormShareDto(form.formId, form.formName, form.createdBy,  form.statusForm, form.createdDate, form.tag, form.beginTime, form.endTime, form.description, form.formCode, form.variableArr, form.jsonFormCondition, form.codeJson, form.configWriter) "
            +
            " From Acl author " +
            " Join Form  form " +
            " On author.formId = form.formId " +
    ...
    @Query("SELECT new com.fis.fpt.service.dto.FormShareDto(" +
